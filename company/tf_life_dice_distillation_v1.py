...
def model(dense_input, linear, embeddings, seq_embeddings, seq_embeddings_mask, label_ctr, label_ctcvr, label_aux,
    ...
    with tf.variable_scope("dnn_common"):
        ...
        fc_input = DNN(hidden_units=[this_dim, this_dim, 512], name='dnn_common', is_training=is_training, activation='dice')(fc_input)
        fc_input_ctr = DNN(
    ...
    loss_aux = tf.losses.log_loss(
        fc_input_ctr,fc_input_cvr,sample_weight_aux,epsilon=1e-10,
        reduction=tf.losses.Reduction.SUM)
